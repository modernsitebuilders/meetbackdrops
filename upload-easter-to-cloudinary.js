// upload-easter-to-cloudinary.js
// Uploads the 4 Easter standard PNGs needed for the comparison widget to Cloudinary,
...
// The 4 standard images needed for comparison widget (match the 4 HD products)
const images = [
  'easter-background-03',
  'easter-background-39',
  'easter-background-42',
  'easter-background-48',
];
