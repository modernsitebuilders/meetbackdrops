...
const PERSONAS = [
  ...
  },
  {
    ...
    rule: {
      categoriesAny: ['office-spaces', 'home-office', 'living-rooms', 'kitchens', 'art-galleries'],
      facetsAny: ['minimal-clean', 'bright-airy', 'neutral-palette', 'serene-calm'],
    },
  ...
  },
  {
    ...
    rule: {
      categoriesAny: ['office-spaces', 'home-office', 'urban-lofts', 'living-rooms'],
      facetsAny: ['home-casual', 'bright-airy', 'formal-executive', 'minimal-clean'],
    },
    exclude: { facetsAny: ['hospitality'] },
    minCount: 12,
    maxShown: 60,
  },
  {
    ...
    rule: {
      categoriesAny: ['bookshelves', 'wall-shelves', 'office-spaces', 'urban-lofts', 'home-office'],
      facetsAny: ['formal-executive', 'bookshelf-library', 'wood-natural'],
    },
    exclude: { facetsAny: ['hospitality', 'nature-greenery', 'minimal-clean'] },
    minCount: 12,
    maxShown: 60,
  },
  {
    ...
    rule: {
      categoriesAny: ['bookshelves', 'wall-shelves', 'libraries', 'home-office', 'living-rooms'],
      facetsAny: ['bookshelf-library', 'wood-natural', 'cozy-warm'],
    },
    exclude: { facetsAny: ['hospitality', 'minimal-clean'] },
    minCount: 12,
    maxShown: 60,
  },
  {
