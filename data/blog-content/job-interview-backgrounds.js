        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <p style={{ marginBottom: '1.25rem' }}>
                Always use high-resolution images (1456×816 minimum). Pixelated or blurry backgrounds look unprofessional and suggest you didn't prepare properly. StreamBackdrops provides high quality backgrounds optimized specifically for video calls.
              </p>
              ...
              <ul style={{ marginBottom: '1.25rem', paddingLeft: '1.5rem' }}>
                <li style={{ marginBottom: '0.5rem' }}>Quality (1456×816 or higher)</li>
