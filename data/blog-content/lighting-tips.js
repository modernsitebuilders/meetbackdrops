        ...
        <div style={{ 
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <p style={{color: '#6b7280', marginBottom: '1rem'}}>
                Once your lighting is dialled in, choosing the right background matters too. Warm-toned lighting pairs naturally with <Link href="/category/bookshelves" style={{color: '#2563eb', textDecoration: 'underline'}}>dark bookshelf backgrounds</Link> and <Link href="/category/home-office" style={{color: '#2563eb', textDecoration: 'underline'}}>home office settings</Link>. Cool, neutral lighting works well with <Link href="/category/bookshelves" style={{color: '#2563eb', textDecoration: 'underline'}}>bright bookshelf backgrounds</Link>, <Link href="/category/office-spaces" style={{color: '#2563eb', textDecoration: 'underline'}}>corporate office spaces</Link>, and <Link href="/category/office-spaces" style={{color: '#2563eb', textDecoration: 'underline'}}>conference room backgrounds</Link>.
              </p>
              <p style={{color: '#6b7280', marginBottom: '1.5rem'}}>
