...
export const CATEGORIES = {
  ...
  "neutral-backgrounds": {
    ...
    "description": "Minimalist neutral and plain wall backgrounds — off-white, greige, and soft gray — for clean, distraction-free professional video calls",
    "count": 11
  },
  "living-rooms": {
    "name": "Living Rooms",
...
export const TOTAL_IMAGES = 1261;
...
export const SEO_DESCRIPTIONS = {
  ...
  "neutral-backgrounds": "Free neutral and plain wall virtual backgrounds for Zoom, Teams & Google Meet. Minimalist off-white, greige and soft-gray walls — no signup, instant download.",
...
export const CATEGORY_KEYWORDS = {
  ...
  "neutral-backgrounds": ["neutral background", "plain background", "minimalist virtual background", "simple zoom background", "off-white wall background", "gray wall video call background", "greige background", "plain wall zoom background"],
