...
// Updated for curated collection with improved descriptions
  ...
  "description": "Modern Christmas backgrounds with clean lines and contemporary holiday decor for professional video calls",
  "count": 54,
  "group": "seasonal"
},
"christmas-traditional": {
  "name": "Christmas - Traditional",
  "description": "Traditional Christmas backgrounds with warm colors, classic decor, and cozy fireplaces for festive video calls",
  "count": 35,
  "group": "seasonal"
},
"christmas-rustic": {
  "name": "Christmas - Rustic",
  "description": "Rustic Christmas backgrounds with farmhouse charm, cabin vibes, and natural holiday decor for cozy video calls",
  "count": 38,
  "group": "seasonal"
},
...
export const SEO_DESCRIPTIONS = {
  ...
  "christmas-modern": "Free modern Christmas virtual backgrounds for video calls. Contemporary holiday backgrounds with clean lines and stylish decor for professional seasonal meetings.",
  "christmas-traditional": "Free traditional Christmas virtual backgrounds for video calls. Classic holiday backgrounds with warm colors, fireplaces, and cozy traditional decor.",
  "christmas-rustic": "Free rustic Christmas virtual backgrounds for video calls. Farmhouse and cabin holiday backgrounds with natural wood and charming seasonal decor.",
...
export const CATEGORY_KEYWORDS = {
  ...
  "christmas-modern": ["modern christmas backgrounds", "contemporary holiday backgrounds", "christmas video calls", "modern christmas decor", "stylish holiday backgrounds", "professional christmas", "clean christmas backgrounds"],
  "christmas-traditional": ["traditional christmas backgrounds", "classic holiday backgrounds", "christmas fireplace backgrounds", "cozy christmas", "warm christmas decor", "traditional holiday", "christmas video calls"],
  "christmas-rustic": ["rustic christmas backgrounds", "farmhouse christmas backgrounds", "cabin christmas", "rustic holiday decor", "natural christmas", "farmhouse holiday", "wood christmas backgrounds"],
