...
export default function Home({ structuredData }) {
  ...
  />
      ...
      <div className={`${styles.categoryGrid} category-grid`}>
        ...
        <Card href="/category/nature-landscapes" title="Nature & Landscapes" description="Stunning natural landscapes and scenic outdoor views for nature-inspired calls" imageSrc="/images/nature-landscapes/nature-landscapes-01.webp" imageAlt="Nature landscape virtual background" navigate={navigate} count={CATEGORIES['nature-landscapes'].count} />        
