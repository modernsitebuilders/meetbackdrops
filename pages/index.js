...
/>
      ...
      <div className={`${styles.categoryGrid} category-grid`}>
        ...
        <Card href="/category/art-galleries" title="Art Galleries" description="Sophisticated art gallery spaces with clean walls" imageSrc="/images/art-galleries/art-gallery-6.webp" imageAlt="Art gallery virtual background" navigate={navigate} count={CATEGORIES['art-galleries'].count} />
